...
public interface Studentmapper
{
 ...
 @Insert("INSERT INTO studentinformation ( stu_num, stu_name, stu_sex, stu_phone, stu_time,stu_class,stu_major,stu_college) " +
         "VALUES (#{stuNum}, #{stuName}, #{stuSex}, #{stuPhone}, #{stuTime}, #{stuClass}, #{stuMajor}, #{stuCollege})")
 ...
 // 根据传入的学生对象更新学生信息
  ...
  @Update("UPDATE studentinformation SET stu_num = #{stuNum},stu_name = #{stuName}, stu_sex = #{stuSex}, " +
          ...
          "stu_time = #{stuTime} WHERE stu_num = #{stuNum}")
